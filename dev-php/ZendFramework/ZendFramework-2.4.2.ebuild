...
SRC_URI="( https://packages.zendframework.com/releases/${P}/${P}.tgz )
	doc? (
		https://packages.zendframework.com/releases/${P}/${P}-apidoc.tgz
		https://packages.zendframework.com/releases/${P}/${P}-manual-en.tgz )"
LICENSE="BSD"
SLOT="0"
